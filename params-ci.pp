...
class os_params {
  ...
  $keystone_allowed_hosts = ['os-ci-test%', '192.168.0.%']
  $keystone_db_host = '192.168.0.47'
  $keystone_db_password = 'H3YPSYaKbKP40DuvHHpdrhYFVpa10A'
  $keystone_db_user = 'keystone'
  $keystone_memchached = ['192.168.0.47:11211']
  $keystone_port = '5000'
  ...
  $swift_memchached = ['192.168.0.47:11211']
  $swift_port = '8080'
  ...
  $rabbit_hosts = ['192.168.0.47:5672']
  ...
  $neutron_allowed_hosts = ['os-ci-test%', '192.168.0.%']
  $neutron_db_host = '192.168.0.47'
  ...
  $nova_allowed_hosts = ['os-ci-test%', '192.168.0.%']
  $nova_db_host = '192.168.0.47'
  ...
  # Glance
  $glance_allowed_hosts = ['os-ci-test%', '192.168.0.%']
  $glance_db_host = '192.168.0.47'
  ...
  # Ceilometer
  $ceilometer_database_connection = 'mongodb://192.168.0.47/ceilometer'
  ...
  # Cinder
  $cinder_allowed_hosts = ['os-ci-test%', '192.168.0.%']
  $cinder_db_host = '192.168.0.47'
