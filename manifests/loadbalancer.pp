...
class cloud::loadbalancer(
  ...
  cloud::loadbalancer::binding { 'spice_cluster':
    ...
    options           => {
      ...
      'balance'        => 'source',
      'timeout server' => $spice_timeout,
      'timeout client' => $spice_timeout,
    },
  ...
  cloud::loadbalancer::binding { 'novnc_cluster':
    ...
    options           => {
      ...
      'option'         => ['tcpka', 'tcplog', 'forwardfor'],
      'balance'        => 'source',
      'timeout server' => $novnc_timeout,
      'timeout client' => $novnc_timeout,
    },
  ...
  cloud::loadbalancer::binding { 'glance_api_cluster':
    ...
    options           => {
      ...
      'balance'        => 'source',
      'option'         => ['tcpka', 'tcplog', 'forwardfor'],
      'timeout server' => $glance_api_timeout,
      'timeout client' => $glance_api_timeout,
    },
