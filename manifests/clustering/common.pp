...
# == Class: cloud::cluster::common
#
# Initialize Pacemaker / Corosync cluster
#
# === Parameters:
# [*cluster_members*]
#   (required) A space-separted list of hostnames of cluster nodes
#
# [*cluster_ip*]
...
#
# [*cluster_password*]
#   (optional) A space-separted list of cluster IP's or names
#   Defaults to false
#
# [*multicast_address*]
